...
| | |
|---|---|
| 📝 **61 إدخال** موثّق عبر 7 فئات كبرى | 🔗 **217 مصدر** موثّق (Tier 1-3) |
| 📘 **40 تطبيقية** (مُثبتة في إنتاج) | 🧪 **17 ناشئة** (واعدة لكن غير مثبتة) |
| 📐 **3 نظرية** (أساس علمي) | 📚 **59 مصطلح** في المعجم العلمي |
| 🧾 **29 ادعاء** مسجل مع مستويات ثقة | 🛠️ **5 أدلة تطبيقية** + **6 مقارنات** تفصيلية |
...
### المكتبة والتصنيف
- [🏆 التصنيف العادل متعدد المعايير](RANKING.md) — Fair MCDA ranking (60 من 61 مُقيّمة)
