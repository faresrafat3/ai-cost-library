...
> **محسوب تلقائياً** من `data/scoring.json` — 12 بُعد × 5 ملفات مستخدم
> **44 تقنية مُقيَّمة** | آخر تحديث: 2026-06-26

---


## 👨‍💻 المطور الفردي | Individual Developer
...
| 🥉 | GPTQ | **81.1** |
| 4. | AWQ | **81.1** |
| 5. | FP8 Quantization | **80.0** |
| 6. | QLoRA | **79.4** |
| 7. | LoRA | **78.3** |
| 8. | Knowledge Distillation | **78.3** |
...
| 🥇 | PagedAttention | **85.3** |
| 🥈 | FlashAttention | **84.7** |
| 🥉 | DeepSpeed ZeRO + FSDP | **83.2** |
| 4. | Knowledge Distillation | **83.2** |
| 5. | Mixed Precision Training | **82.6** |
| 6. | FP8 Quantization | **81.6** |
| 7. | GPTQ | **81.1** |
| 8. | AWQ | **81.1** |
...
|---|---------|--------|
| 🥇 | FlashAttention | **83.0** |
| 🥈 | MoE Economics (DeepSeek-V3) | **83.0** |
| 🥉 | Knowledge Distillation | **82.6** |
| 4. | PagedAttention | **80.0** |
